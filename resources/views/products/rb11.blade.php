...
<body>
    ...
    <main class="product">
        ...
        <section class="section product__modes">
            ...
            <div id="cards" class="cards__wrapper cards row">
                <div class="card card--tall">
                    <div class="card-content">
                        <img class="card__image mb-2" src="{{ asset('img/rollers.png') }}" alt="">
                        <p class="card__paragraph text-left" style="text-align: justify;">
                            {{ __('products/rb11.mode1') }}
                        </p>
                    </div>
                </div>
                <div class="card card--tall">
                    <div class="card-content">
                        <img class="card__image mb-2" src="{{ asset('img/zaw.png') }}" alt="">
                        <p class="card__paragraph text-left" style="text-align: justify;">
                ...
                <div class="card card--tall">
                    <div class="card-content">
                        <img class="card__image mb-2" src="{{ asset('img/kosz.png') }}" alt="">
                        <p class="card__paragraph text-left" style="text-align: justify;">
        ...
        <section class="section background--black ">
            <div id="cards" class="row w-100 cards2">
                <div class="card ">
                    <div class="card-content card-content--center" style="background-image: url('{{ asset('img/icons/faq.png') }}')">
                        <h4 class="heading-4 p-1 text--center">Często zadawane pytania</h3>
                            <a href="faq" class="btn btn--empty color--black">Zobacz</a>
                    </div>
                </div>
                <div class="card">
                    <div class="card-content card-content--center">
                        <h4 class="heading-4 p-1 text--center">Proces zamawiania produktów</h3>
                            <a href="/order" class="btn btn--empty color--black">Zobacz</a>
                    </div>
                </div>
                <div class="card">
                    <div class="card-content card-content--center">
                        <h4 class="heading-4 p-1 text--center">Formularz kontaktowy</h3>
                            <a href="../#contact" class="btn btn--empty color--black">Zobacz</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="section product__recommend d-flex flex-center">
            <div class="row">
                <div class="col-1-of-2">
